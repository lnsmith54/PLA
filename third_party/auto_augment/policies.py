...
def color_policies():
    ...
    policies = [
        [('Brightness', 0.5, 1), ('Contrast', 0.1, 7)],
        [('Brightness', 0.4, 1), ('Color', 0.2, 4)],
        [('AutoContrast', 0.6, 1), ('Color', 0.7, 4)],
        [('Color', 0.2, 6), ('AutoContrast', 0.1, 2)],
        [('Brightness', 0.9, 6), ('Color', 0.2, 8)],
        [('AutoContrast', 0.8, 0), ('Color', 0.7, 6)],
        [('TranslateY', 0.2, 7), ('Color', 0.9, 6)],
        [('Equalize', 0.7, 6), ('Color', 0.4, 9)],
        [('Color', 0.4, 3), ('Brightness', 0.6, 7)],
        [('Sharpness', 0.3, 9), ('Brightness', 0.7, 9)],
        ...
        [('Color', 0.2, 6), ('AutoContrast', 0.1, 2)],
        [('Brightness', 0.9, 6), ('Color', 0.2, 8)],
        [('AutoContrast', 0.8, 0), ('Color', 0.7, 3)],
        [('TranslateY', 0.2, 7), ('Color', 0.9, 7)],
        [('Equalize', 0.7, 6), ('Color', 0.4, 5)],
